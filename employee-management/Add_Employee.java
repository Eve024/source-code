...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
      /*  ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee/Icons/4.jpg"));
        id15.setIcon(img);*/
        ...
        id12= new JLabel("Employee Id");
        id12.setBounds(450,350,140,30);
        id12.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id12);

        t11=new JTextField();   
        t11.setBounds(650,350,150,30);
        id15.add(t11);
