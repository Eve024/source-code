...
class Remove_Employee implements ActionListener{
    ...
    Remove_Employee(){
        ...
        Font F6=new Font("serif",Font.PLAIN,20); 
        l6.setFont(F6);
        l5.add(l6);
        ...
        Font F7=new Font("serif",Font.PLAIN,20); 
        l7.setFont(F7);
        l5.add(l7);
        ...
        l8=new JLabel();
        l8.setBounds(200,300,350,30);
        l8.setForeground(Color.blue);
        Font f8=new Font("serif",Font.PLAIN,20); 
        l8.setFont(f8);
        l5.add(l8);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "select fname,phone,email from employee where ID ='"+t.getText()+"' ";
