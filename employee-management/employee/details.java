...
class details  implements ActionListener{
    ...
    details(){
       ...
       /* l1 = new JLabel();
        ...
        l1.setLayout(null);
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Employee/Icons/3.jpg"));
        l1.setIcon(i1);
        f.add(l1);*/
       
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Employee/Icons/view1.jpg"));
